...
public class IntImportCarrierHomeActivity extends Activity {
    ...
    private void initView() {
        ...
        navBar.setTitle("国际进港当天业务量详情");
        navBar.setRight(R.drawable.search);
        navBar.getRightImageView().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(IntImportCarrierHomeActivity.this, IntImportCarrierActivity.class);
        ...
        loadingDialog.show();
        HttpRoot.getInstance().requstAync(IntImportCarrierHomeActivity.this, HttpCommons.CGO_GET_INT_IMPORT_REPORT_NAME,
                ...
                new HttpRoot.CallBack() {
                    ...
                    public void onSucess(Object result) {
                        ...
                        if (intExportCarrierInfoList != null && intExportCarrierInfoList.size() >= 1) {
                            intDayAdapter = new IntDayAdapter(IntImportCarrierHomeActivity.this, intExportCarrierInfoList);
