...
public class HttpCGOExportOneKeyDeclare {
    public static SoapObject cgoExportOneKeyDeclare(String userBumen, String userName, String userPass, String loginFlag, String mawb) {
        // 定义SoapHeader，加入4个节点
        ...
        SoapObject rpc = new SoapObject(HttpCommons.NAME_SPACE, HttpCommons.CGO_EXPORT_ONE_KEY_DECLARE_NAME);
        ...
        try {
            // 调用webservice
            transportSE.call(HttpCommons.CGO_EXPORT_ONE_KEY_DECLARE_ACTION, envelope);
        } catch (Exception e) {
            e.printStackTrace();
        }
