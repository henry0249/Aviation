...
import com.example.administrator.aviation.ui.base.ProgressWheel;
...
public class AbPullToRefreshView extends LinearLayout {
     ...
     * header view.
     */
    private com.example.administrator.aviation.ui.base.AbListViewHeader mHeaderView;

    /**
     * footer view.
     */
    private com.example.administrator.aviation.ui.base.AbListViewFooter mFooterView;
    ...
    private void addHeaderView() {
        mHeaderView = new com.example.administrator.aviation.ui.base.AbListViewHeader(mContext);
    ...
    private void addFooterView() {
        ...
        mFooterView = new com.example.administrator.aviation.ui.base.AbListViewFooter(mContext);
    ...
    private void headerPrepareToRefresh(int deltaY) {
        ...
        if (newTopMargin >= 0 && mHeaderView.getState() != com.example.administrator.aviation.ui.base.AbListViewHeader.STATE_REFRESHING) {
            //提示松开刷新
            mHeaderView.setState(com.example.administrator.aviation.ui.base.AbListViewHeader.STATE_READY);

        } else if (newTopMargin < 0 && newTopMargin > -mHeaderViewHeight) {
            //提示下拉刷新
            mHeaderView.setState(com.example.administrator.aviation.ui.base.AbListViewHeader.STATE_NORMAL);
        }
    }
    ...
    private void footerPrepareToRefresh(int deltaY) {
        ...
        if (Math.abs(newTopMargin) >= (mHeaderViewHeight + mFooterViewHeight) && mFooterView.getState() != com.example.administrator.aviation.ui.base.AbListViewFooter.STATE_LOADING) {
            mFooterView.setState(com.example.administrator.aviation.ui.base.AbListViewFooter.STATE_READY);
        } else if (Math.abs(newTopMargin) < (mHeaderViewHeight + mFooterViewHeight)) {
            mFooterView.setState(com.example.administrator.aviation.ui.base.AbListViewFooter.STATE_LOADING);
        }
    }
    ...
    public void headerRefreshing() {
        ...
        mHeaderView.setState(com.example.administrator.aviation.ui.base.AbListViewHeader.STATE_REFRESHING);
    ...
    public void onHeaderRefreshFinish() {
        if (mHeaderView.getState() == com.example.administrator.aviation.ui.base.AbListViewHeader.STATE_REFRESHING) {
            ...
            if (mAdapterView != null) {
                ...
                if (mCount > 0) {
                    ...
                    mFooterView.setState(com.example.administrator.aviation.ui.base.AbListViewFooter.STATE_EMPTY);
                }
            } else {
                mFooterView.setState(com.example.administrator.aviation.ui.base.AbListViewFooter.STATE_READY);
            }
    ...
    public void onFooterLoadFinish() {
        ...
        if (mAdapterView != null) {
            ...
            if (countNew > mCount) {
                ...
                mFooterView.setState(com.example.administrator.aviation.ui.base.AbListViewFooter.STATE_NO);
            }
        } else {
            mFooterView.setState(com.example.administrator.aviation.ui.base.AbListViewFooter.STATE_READY);
        }
     ...
     */
    public com.example.administrator.aviation.ui.base.AbListViewHeader getHeaderView() {
        return mHeaderView;
    }
     ...
     */
    public com.example.administrator.aviation.ui.base.AbListViewFooter getFooterView() {
        return mFooterView;
    }
