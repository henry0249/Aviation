...
public abstract class AbsCommonAdapter<T> extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final com.example.administrator.aviation.model.adapter.AbsViewHolder viewHolder = getViewHolder(position, convertView, parent);
        convert(viewHolder, getItem(position), position);
        return viewHolder.getConvertView();

    }

    public abstract void convert(com.example.administrator.aviation.model.adapter.AbsViewHolder helper, T item, int pos);

    private com.example.administrator.aviation.model.adapter.AbsViewHolder getViewHolder(int position, View convertView, ViewGroup parent) {
        return com.example.administrator.aviation.model.adapter.AbsViewHolder.get(
