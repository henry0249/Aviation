...
public class HttpIntMawbDelete {
    public static SoapObject deleteIntMawb(String userBumen, String userName, String userPass, String loginFlag, String mawb){
        // 定义SoapHeader，加入4个节点
        ...
        SoapObject rpc = new SoapObject(HttpCommons.NAME_SPACE, HttpCommons.DELETE_INT_MAWB_METHOD_NAME);
        ...
        try {
            // 调用webservice
            transportSE.call(HttpCommons.DELETE_INT_MAWB_METHOD_ACTION, envelope);
        } catch (Exception e){
            e.printStackTrace();
        }
