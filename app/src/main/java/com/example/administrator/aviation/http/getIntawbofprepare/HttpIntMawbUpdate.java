...
public class HttpIntMawbUpdate {
    public static SoapObject updateIntMawb(String userBumen, String userName, String userPass, String loginFlag, String xml){
        // 定义SoapHeader，加入4个节点
        ...
        SoapObject rpc = new SoapObject(HttpCommons.NAME_SPACE, HttpCommons.UPDATE_INT_MAWB_METHOD_NAME);
        ...
        try {
            // 调用webservice
            transportSE.call(HttpCommons.UPDATE_INT_MAWB_METHOD_ACTION, envelope);
        } catch (Exception e){
            e.printStackTrace();
        }
    ...
    public static String updateIntMawbXml(String mawbId,String mawb,String pc,String weight,String volume,
    ...
    public static String addIntMawbXml(String mawbId,String mawb,String pc,String weight,String volume,
                                          String spcode,String goods, String goodsCN, String businessType,
                                          String pacKage,String origin, String dep,String dest1, String by1,
                                          String tranFlag,String remark, String fDate, String fno, String customsCode,
                                          String transPortMode, String freightPayment, String shipper,
                                          String consignee, String gprice) {
        String xml = new String ("<IntExportPrepareAWB>"
