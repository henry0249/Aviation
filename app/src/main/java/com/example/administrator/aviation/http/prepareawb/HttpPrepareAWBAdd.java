...
public class HttpPrepareAWBAdd {
    public static SoapObject addAWBdetail(String userBumen, String userName, String userPass, String loginFlag, String xml){
        // 定义SoapHeader，加入4个节点
        ...
        SoapObject rpc = new SoapObject(HttpCommons.NAME_SPACE, HttpCommons.AWB_ADD_METHOD_NAME);
        ...
        try {
            // 调用webservice
            transportSE.call(HttpCommons.AWB_ADD_METHOD_ACTION, envelope);
        } catch (Exception e){
            e.printStackTrace();
        }
