...
public class DomExportDayCarrierActivity extends Activity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.declare_info_begin_time_btn:
                choseTimeMethod.getCurrentTime(DomExportDayCarrierActivity.this, declareInfoBeginTimeEt);
                break;
            ...
            case R.id.declare_info_search_btn:
                ...
                HttpRoot.getInstance().requstAync(DomExportDayCarrierActivity.this, HttpCommons.CGO_GET_DOM_EXPORT_DAY_REPORT_NAME,
