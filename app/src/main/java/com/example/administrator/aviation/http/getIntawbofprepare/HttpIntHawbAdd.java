...
public class HttpIntHawbAdd {
    public static SoapObject addIntChild(String userBumen, String userName, String userPass, String loginFlag, String xml){
        // 定义SoapHeader，加入4个节点
        ...
        SoapObject rpc = new SoapObject(HttpCommons.NAME_SPACE, HttpCommons.ADD_INT_HAWB_METHOD_NAME);
        ...
        try {
            // 调用webservice
            transportSE.call(HttpCommons.ADD_INT_HAWB_METHOD_ACTION, envelope);
        } catch (Exception e){
            e.printStackTrace();
        }
