...
public class KuaiJianSaoMiaoDecodeHandler extends Handler {
    private final KuaiJianSaoMiaoMainActivity activity;
    private final MultiFormatReader multiFormatReader;
    private boolean running = true;

    public KuaiJianSaoMiaoDecodeHandler(KuaiJianSaoMiaoMainActivity activity, Map<DecodeHintType, Object> hints) {
    ...
    private static void bundleThumbnail(PlanarYUVLuminanceSource source, Bundle bundle) {
        ...
        bundle.putByteArray(com.example.administrator.aviation.tool.qr.DecodeThread.BARCODE_BITMAP, out.toByteArray());
    }
