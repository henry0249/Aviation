...
public class HttpPrepareImpCargoShenBao {
    public static SoapObject shenBaoCargo(String userBumen, String userName, String userPass, String loginFlag, String mawb){
        // 定义SoapHeader，加入4个节点
        ...
        SoapObject rpc = new SoapObject(HttpCommons.NAME_SPACE, HttpCommons.CGO_DECLERE_INT_IMPORT_HAWB_NAME);
        ...
        try {
            // 调用webservice
            transportSE.call(HttpCommons.CGO_DECLERE_INT_IMPORT_HAWB_ACTION, envelope);
        } catch (Exception e){
            e.printStackTrace();
        }
