...
public class Declare implements Serializable{
    ...
    private String MftMSGID;
    private String PC;
    private String Weight;
    private String Volume;
    private String ArrivalStatus;
    private String ArrMSGID;
    ...
    public String getMftMSGID() {
        return MftMSGID;
    }

    public void setMftMSGID(String mftMSGID) {
        MftMSGID = mftMSGID;
    }
    ...
    public String getArrMSGID() {
        return ArrMSGID;
    }

    public void setArrMSGID(String arrMSGID) {
        ArrMSGID = arrMSGID;
    }
}
