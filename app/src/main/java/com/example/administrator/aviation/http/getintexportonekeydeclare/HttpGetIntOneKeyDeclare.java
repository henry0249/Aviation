...
public class HttpGetIntOneKeyDeclare {
    public static SoapObject getDeclareDetail(String userBumen, String userName, String userPass, String loginFlag, String xml){
        // 定义SoapHeader，加入4个节点
        ...
        SoapObject rpc = new SoapObject(HttpCommons.NAME_SPACE, HttpCommons.GET_INT_EXPORT_ONE_KEY_DECLARE_NAME);
        ...
        try {
            // 调用webservice
            transportSE.call(HttpCommons.GET_INT_EXPORT_ONE_KEY_DECLARE_ACTION, envelope);
        } catch (Exception e){
            e.printStackTrace();
        }
    ...
    public static String getDeclareDetailXml(String Mawb, String begintime, String endTime) {
