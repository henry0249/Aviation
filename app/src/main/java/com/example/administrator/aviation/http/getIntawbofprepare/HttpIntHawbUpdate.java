...
public class HttpIntHawbUpdate {
    public static SoapObject updateIntHawb(String userBumen, String userName, String userPass, String loginFlag, String xml){
        // 定义SoapHeader，加入4个节点
        ...
        SoapObject rpc = new SoapObject(HttpCommons.NAME_SPACE, HttpCommons.UPDATE_INT_HAWB_METHOD_NAME);
        ...
        try {
            // 调用webservice
            transportSE.call(HttpCommons.UPDATE_INT_HAWB_METHOD_ACTION, envelope);
        } catch (Exception e){
            e.printStackTrace();
        }
    ...
    public static String getIntHawbXml(String mawbId,String mawb, String hawbId,String hno,String pc,String weight,
                                       String volume,String goods, String goodsCN) {
        String xml = new String ("<IntExportPrepareAWB>"
        +"<MawbInfo>" +"<Mawb>"+ mawb + "</Mawb>"
    ...
    public static String addIntHawbXml(String mawbId,String hawbId,String hno,String pc,String weight,
                                       String volume,String goods, String goodsCN) {
        String xml = new String ("<IntExportPrepareAWB>"
                +"<MawbInfo>"
                +"<Mawb>"+ mawbId + "</Mawb>"
