...
public class HttpCGOMergerSubLineArrival {
    public static SoapObject cGOMergerSubLineArrival(String userBumen, String userName, String userPass, String loginFlag, String xml) {
        // 定义SoapHeader，加入4个节点
        ...
        SoapObject rpc = new SoapObject(HttpCommons.NAME_SPACE, HttpCommons.CGO_MERGER_SUB_LINE_ARRIVAL_NAME);
        ...
        try {
            // 调用webservice
            transportSE.call(HttpCommons.CGO_MERGER_SUB_LINE_ARRIVAL_ACTION, envelope);
        } catch (Exception e) {
            e.printStackTrace();
        }
