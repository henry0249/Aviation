...
public class IntImportDayManifestActivity extends Activity {
    ...
    private  Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == AviationCommons.INT_E_DAY_MANIFEST) {
                IntEManifestAdapter intEManifestAdapter = new IntEManifestAdapter(IntImportDayManifestActivity.this, intExportDayManifestInfoList);
    ...
    private void initView() {
        ...
        HttpRoot.getInstance().requstAync(IntImportDayManifestActivity.this, HttpCommons.CGO_GET_INT_IMPORT_MANIFEST_NAME,
                HttpCommons.CGO_GET_INT_IMPORT_MANIFEST_ACTION, params,
