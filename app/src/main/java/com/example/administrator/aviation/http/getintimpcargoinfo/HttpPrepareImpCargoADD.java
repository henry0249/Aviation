...
public class HttpPrepareImpCargoADD {
    public static SoapObject addCargodetail(String userBumen, String userName, String userPass, String loginFlag, String xml){
        // 定义SoapHeader，加入4个节点
        ...
        SoapObject rpc = new SoapObject(HttpCommons.NAME_SPACE, HttpCommons.CGO_ADD_INT_IMPORT_HAWB_NAME);
        ...
        try {
            // 调用webservice
            transportSE.call(HttpCommons.CGO_ADD_INT_IMPORT_HAWB_ACTION, envelope);
        } catch (Exception e){
            e.printStackTrace();
        }
