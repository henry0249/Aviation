...
public class HttpIntMawbDeclare {
    public static SoapObject declareIntMawb(String userBumen, String userName, String userPass, String loginFlag, String mawb){
        // 定义SoapHeader，加入4个节点
        ...
        SoapObject rpc = new SoapObject(HttpCommons.NAME_SPACE, HttpCommons.DECLARE_INT_MAWB_METHOD_NAME);
        ...
        try {
            // 调用webservice
            transportSE.call(HttpCommons.DECLARE_INT_MAWB_METHOD_ACTION, envelope);
        } catch (Exception e){
            e.printStackTrace();
        }
