...
public class IntExportDayManifestActivity extends Activity {
    ...
    private  Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == AviationCommons.INT_E_DAY_MANIFEST) {
                IntEManifestAdapter intEManifestAdapter = new IntEManifestAdapter(IntExportDayManifestActivity.this, intExportDayManifestInfoList);
    ...
    private void initView() {
        ...
        navBar.setTitle("出港舱单信息列表");
        navBar.hideRight();

        String fdate = getIntent().getStringExtra("mdate");
        String fno = getIntent().getStringExtra("mfno");

        String xml = getXml(fdate, fno);
        Map<String, String> params = new HashMap<>();
        params.put("awbXml", xml);
        params.put("ErrString", "");
        HttpRoot.getInstance().requstAync(IntExportDayManifestActivity.this, HttpCommons.CGO_GET_INT_EXPORT_MANIFEST_NAME,
                HttpCommons.CGO_GET_INT_EXPORT_MANIFEST_ACTION, params,
    ...
    private class IntEManifestAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup viewGroup) {
            ...
            if (convertView == null) {
                ...
                viewHolder.qiyungangTv = (TextView) convertView.findViewById(R.id.qiyungang_tv);
            ...
            String qiyungang = intExportDayManifestInfoList.get(position).getDep();
            if (qiyungang != null && !qiyungang.equals("")) {
                viewHolder.qiyungangTv.setText(qiyungang);
            } else {
                viewHolder.qiyungangTv.setText("");
            }
