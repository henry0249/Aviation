...
public class IntImportCarrierActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.declare_info_begin_time_btn:
                choseTimeMethod.getCurrentTime(IntImportCarrierActivity.this, declareInfoBeginTimeEt);
                break;

            case R.id.declare_info_end_time_btn:
                choseTimeMethod.getCurrentTime(IntImportCarrierActivity.this, declareInfoEndTimeEt);
                break;
            ...
            case R.id.declare_info_search_btn:
                ...
                HttpRoot.getInstance().requstAync(IntImportCarrierActivity.this, HttpCommons.CGO_GET_INT_IMPORT_REPORT_NAME,
                        HttpCommons.CGO_GET_INT_IMPORT_REPORT_ACTION, params,
