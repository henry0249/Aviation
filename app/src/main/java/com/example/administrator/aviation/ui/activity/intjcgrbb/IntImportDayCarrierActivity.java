...
public class IntImportDayCarrierActivity extends Activity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.declare_info_begin_time_btn:
                choseTimeMethod.getCurrentTime(IntImportDayCarrierActivity.this, declareInfoBeginTimeEt);
                break;
            ...
            case R.id.declare_info_search_btn:
                ...
                HttpRoot.getInstance().requstAync(IntImportDayCarrierActivity.this, HttpCommons.CGO_GET_INT_IMPORT_DAY_REPORT_NAME,
...
//                                Toast.makeText(IntImportDayCarrierActivity.this, xml, Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(IntImportDayCarrierActivity.this, IntImportDayCarrierDetailActivity.class);
