...
public class HttpPrepareImpCargoInfo {
    public static SoapObject getImpCargoInfo(String userBumen, String userName, String userPass, String loginFlag, String xml){
        // 定义SoapHeader，加入4个节点
        ...
        SoapObject rpc = new SoapObject(HttpCommons.NAME_SPACE, HttpCommons.CGO_GET_INT_IMPORT_CARGO_INFOMATION_NAME);
        ...
        try {
            // 调用webservice
            transportSE.call(HttpCommons.CGO_GET_INT_IMPORT_CARGO_INFOMATION_ACTION, envelope);
        } catch (Exception e){
            e.printStackTrace();
        }
    ...
    public static String getImpCargoXml(String Mawb,String fno , String begintime, String endTime) {
        String xml = new String("<IntImportCargo>"
                +"<CGOCondition>"
                +"<Mawb>"+Mawb+"</Mawb>"
                +"<Fno>"+fno+"</Fno>"
    ...
    public static String getAddUpdataDeleteXml(String HawbID, String Mawb, String Hno, String BusinessType, String PC, String Weight,
                                               String Volume, String Goods, String Remark) {
        String xml = new String("<IntImportHawb>"
                + "<HawbID>" + HawbID + "</HawbID>"
                + "<Mawb>" + Mawb + "</Mawb>"
                + " <Hno>" + Hno + "</Hno>"
