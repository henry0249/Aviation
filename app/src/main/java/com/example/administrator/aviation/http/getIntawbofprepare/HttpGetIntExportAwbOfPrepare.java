...
public class HttpGetIntExportAwbOfPrepare {
    ...
    public static SoapObject getIntExportAwbOfPrepareInfo(String userBumen, String userName, String userPass, String loginFlag){
        // 定义SoapHeader，加入4个节点
        ...
        SoapObject rpc = new SoapObject(HttpCommons.NAME_SPACE, HttpCommons.GET_INT_METHOD_NAME);
        ...
        try {
            // 调用webservice
            transportSE.call(HttpCommons.GET_INT_METHOD_ACTION, envelope);
        } catch (Exception e){
            e.printStackTrace();
        }
