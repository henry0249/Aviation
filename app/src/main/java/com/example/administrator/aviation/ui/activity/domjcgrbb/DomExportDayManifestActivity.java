...
public class DomExportDayManifestActivity extends Activity {
    ...
    private  Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == AviationCommons.INT_E_DAY_MANIFEST) {
                IntEManifestAdapter intEManifestAdapter = new IntEManifestAdapter(DomExportDayManifestActivity.this, intExportDayManifestInfoList);
    ...
    private void initView() {
        ...
        HttpRoot.getInstance().requstAync(DomExportDayManifestActivity.this, HttpCommons.CGO_GET_DOM_EXPORT_MANIFEST_NAME,
                HttpCommons.CGO_GET_DOM_EXPORT_MANIFEST_ACTION, params,
