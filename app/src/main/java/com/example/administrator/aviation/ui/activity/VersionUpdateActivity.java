    ...
    private Handler handler1 = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (isNeedUpdate()) {
                ...
                Toast.makeText(VersionUpdateActivity.this, "当前是最新版本", Toast.LENGTH_LONG).show();
            }
        }
    };
...
//                    startService(intent);
                    ...
                    Toast.makeText(VersionUpdateActivity.this, "SD卡不可用", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    void downFile(final String url) {
        ...
        pBar = new ProgressDialog(VersionUpdateActivity.this);
